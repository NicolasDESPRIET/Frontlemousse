...
export enum constantsSharedButtons {
    BACK_HOME_BUTTON = 'Retour accueil',
}
...
HOME PAGE
==========================*/
export enum constantsHomeButtons {
    INTERN_WORKSPACE_BTN = 'Espace stagiaire',
    ADMIN_WORKSPACE_BTN = 'Espace administrateur'
}
